 ...
 * @copyright 2013 Rajesh Taneja <rajesh@moodle.com>, 2015 Anthony Kuske <www.anthonykuske.com>
...
class enrol_self_parents_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_instance_info() {
        ...
        $instanceinfo1 = enrol_self_parents_external::get_instance_info($instanceid1);
        ...
        $instanceinfo2 = enrol_self_parents_external::get_instance_info($instanceid2);
        ...
        $this->assertEquals(get_string('canntenrol', 'enrol_self_parents'), $instanceinfo2['status']);
        $this->assertFalse(isset($instanceinfo2['enrolpassword']));

        $instanceinfo3 = enrol_self_parents_external::get_instance_info($instanceid3);
        ...
        $this->assertEquals(get_string('password', 'enrol_self_parents'), $instanceinfo3['enrolpassword']);
    }
}
