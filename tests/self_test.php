 ...
 * @category   phpunit
 * @copyright  2012 Petr Skoda {@link http://skodak.org}, 2015 Anthony Kuske <www.anthonykuske.com>
...
class enrol_self_parents_testcase extends advanced_testcase
{

    public function test_basics() {

        $this->assertTrue(enrol_is_enabled('self_parents'));
        $plugin = enrol_get_plugin('self_parents');
        $this->assertInstanceOf('enrol_self_parents_plugin', $plugin);
        $this->assertEquals(1, get_config('enrol_self_parents', 'defaultenrol'));
        $this->assertEquals(ENROL_EXT_REMOVED_KEEP, get_config('enrol_self_parents', 'expiredaction'));
    }
    ...
    public function test_send_expiry_notifications() {
        ...
        /** @var $selfplugin enrol_self_parents_plugin */
        $selfplugin = enrol_get_plugin('self_parents');
    ...
    public function test_can_self_enrol() {
        ...
        $expectederrorstring = get_string('canntenrol', 'enrol_self_parents');
